...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModalModalComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ModalComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var ModalComponent = /*#__PURE__*/function () {
      function ModalComponent(dialogRef, modalData) {
    ...
    ModalComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [["id", "modal-content-wrapper"], ["id", "modal-header"], ["id", "modal-body"], [4, "ngIf"], ["id", "modal-footer"], [1, "btn", "btn-primary", "btn-sm", 3, "click"], ["height", "325px", "width", "450px", 3, "src"]],
